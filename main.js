...
function Mat(){
  var material = new THREE.MeshPhongMaterial({
    ...
    emissive   : new THREE.Color("rgb(255,0,0)"), //Emissive(light) color of the material, essentially a solid color unaffected by other lighting. Default is black.
    specular   : new THREE.Color("rgb(0,255,0)"), /*Specular color of the material, i.e., how shiny the material is and the color of its shine. 
